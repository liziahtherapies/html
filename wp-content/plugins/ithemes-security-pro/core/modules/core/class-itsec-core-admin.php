...
class ITSEC_Core_Admin {
	...
	public function metabox_need_help() {
		...
		echo '<p><a class="button-secondary" href="https://ithemes.com/security/ithemes-security-professional-setup" target="_blank">' . __( 'Have an expert secure my site', 'it-l10n-ithemes-security-pro' ) . '</a></p>';
