(function($){
	...
	$(document).ready( function(){
		...
		$( '#et_top_search' ).click( function() {
			...
			$( '.et_menu_container' ).removeClass( 'et_pb_menu_visible' ).removeClass( 'et_pb_no_animation' ).addClass('et_pb_menu_hidden1');
		...
		function et_hide_search() {
			$( '.et_menu_container' ).removeClass('et_pb_menu_hidden1').removeClass( 'et_pb_no_animation' ).addClass( 'et_pb_menu_visible' );
